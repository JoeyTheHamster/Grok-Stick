...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ERiUb5WS.mjs");
...
var manifest = { "baab326d137db5e8586a9a1ae18c095b1192cd4aba8cf1ea321735246a8201c9": {
	functionName: "getCliVersion_createServerFn_handler",
	importer: () => import("./version-DQz9aZqj.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DJRtFSay.mjs").then((n) => n.t),
