...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DJRtFSay.js
...
var styles_default = "/assets/styles-t40U3YnI.css";
var APP_NAME = "Grok Stick";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Carry the Grok CLI on a USB flash drive. No install on the host — login, settings, and the binary live on the stick."
			},
			{
				name: "theme-color",
				content: "#0c0d0f"
...
var getCliVersion = createServerFn({ method: "GET" }).handler(createSsrRpc("baab326d137db5e8586a9a1ae18c095b1192cd4aba8cf1ea321735246a8201c9"));
var $$splitComponentImporter = () => import("./routes-E8Jn9dFB.mjs");
